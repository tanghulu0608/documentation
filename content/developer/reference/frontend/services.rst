    ...
    .. list-table::
      ...
      * - `bypassEditableProtection`
        ...
        - If true the hotkey service will call this registration
          ...
          Kind of similar to :ref:`frontend/services/hotkey/data-allow-hotkeys-attribute`.
      * - `global`
        - boolean
        - false
...
.. _frontend/services/hotkey/data-allow-hotkeys-attribute:

The `[data-allow-hotkeys]` attribute
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

By default the hotkey service protects all editable elements.
...
the `[data-allow-hotkeys]` attribute to true.
